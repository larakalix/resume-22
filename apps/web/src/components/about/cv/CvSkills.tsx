...
const content = {
  skills: [
    ...
    {
      title: "Tools",
      skills: ["VS Code", "Git (Github, Gitlab)", "DevOps (Azure)", "Figma"],
    },
    {
      title: "Mobile",
    ...
    <div className="bg-v-dark-purple px-12 pt-5 pb-10 rounded-v-rounded flex flex-col gap-8 max-w-full md:max-w-sm">
      <section>
        ...
        <div className="flex flex-col gap-4 text-[.8rem] text-v-black dark:text-white">
          <p>
            With over 7 years of expertise, I&apos;m a Fullstack Developer, with
            a massive passion for coding, in order to perform user experience. I
            can help you to reach your goals, by providing a high-quality
            product developing your ideas.
          </p>

          <p>
            I have experience working on custom applications, e-commerce, micro
            websites, and Rest APIs. I&apos;m open to grabbing another kind of
            knowledge with respect to other programming languages
          </p>
        </div>
      </section>
