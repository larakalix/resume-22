...
export const CvExptertise = () => {
  return (
    <div className="bg-black px-12 pt-5 pb-10 rounded-v-rounded text-v-black dark:text-white flex flex-col flex-1">
      <h3 className="uppercase text-[1.8rem] font-bold py-4 ">Expertise</h3>

      <div className="flex flex-col gap-4">
        <ExpertiseSquare
          title="NOVATECH | JavaScript Frontend Dev"
          place="El Salvador/ Jan 2022 - Current"
          skills={[
        ...
        <ExpertiseSquare
          ...
          skills={["Frontend: ReactJS, Redux", "Tools: Jira, Confluence, Git"]}
          brief={[
            "During this position, I developer new features to help users to manange their data in a better way, using clean UI views to handle business logic, and reduce loading times.",
            "The project is currently using a java backend service, so my work was to create new features to consume data from new endpoints, and develop final user views for them to get an easier experience because of the data complexity that they need to handle.",
          ]}
        />
