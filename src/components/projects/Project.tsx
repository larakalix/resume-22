...
export const Project = ({ id, name, github, link }: ProjectProps) => (
    <div className="w-full h-[20rem] flex justify-center items-center bg-blue-200 rounded flex-col">
        ...
        <ul className="flex justify-between items-center">
            <li>
                <a href={link} target="_blank" rel="noreferrer" className="flex items-center justify-center p-3 bg-green-500 text-white text-xl min-h-[4rem] mx-2 rounded">
                    Check it out
                </a>
            </li>
            {
...
const GithubButton = ({ github }: { github: string }) => (
    <li>
        <a href={github} target="_blank" rel="noreferrer" className="flex items-center justify-center p-3 bg-black text-white text-xl min-h-[4rem] mx-2 rounded">
